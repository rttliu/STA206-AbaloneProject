...
We investigate multiple modeling strategies to address **nonlinear relationships**, **influential points**, **multicollinearity**, and the trade-off between **predictive performance**, **model robustness**, and **interpretability**. The project received a raw score of **19/20 (90%)**.
